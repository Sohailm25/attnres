# ABOUTME: Runs the first mediator-conditioned safety routing follow-up on aligned Gemma.
# ABOUTME: Saves projection-trajectory summaries anchored on the validated refusal direction.

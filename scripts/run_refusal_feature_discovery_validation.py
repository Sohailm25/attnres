# ABOUTME: Runs the refusal-feature discovery workflow validation on an aligned Gemma model.
# ABOUTME: Saves prompt-level residual checkpoints plus held-out refusal and harmfulness separation summaries.
...
def main() -> int:
    from validation.safety_alignment import run_refusal_feature_discovery_validation
